...
def main():
    ...
    parser.add_argument('--input_proteins_gff', default="", help="Full path to the proteins gff file")
    parser.add_argument('--input_proteins_faa', default="", help="Full path to the proteins faa file")
    ...
    proteins_gff = args.input_proteins_gff
    proteins_faa = args.input_proteins_gff
    output_csv_base = args.output
    chunk_size = args.chunk_size

    header = ['id', 'assembly', "proteins_gff", "proteins_faa"]
    rows = []
