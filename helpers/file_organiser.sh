...
function GenerateRNACentralJSON {
    ...
    python3 /nfs/production/rdf/metagenomics/pipelines/prod/genomes-pipeline/database-import-scripts/rnacentral/generate_rnacentral_json.py \
    -r /nfs/production/rdf/metagenomics/pipelines/prod/genomes-pipeline/database-import-scripts/rnacentral/rfam_model_lengths_14.9.txt \
